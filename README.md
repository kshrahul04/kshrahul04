...
|--------|-------------|-------|
| 🧾 [Invoice Payment Predictor](https://github.com/kshrahul04) | ML model predicting late invoice payments using Random Forest | Python, Scikit-learn, Streamlit |
| ⛓️ [Blockchain Subscription Service](https://github.com/kshrahul04) | Smart contract with tiered subscription model on Ethereum | Solidity, Ethereum |
| 🏦 [NSE Data Warehouse Chatbot](https://github.com/kshrahul04) | NLP chatbot translating plain English to SQL queries | SQL, Cloudera, Python |
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=kshrahul04&layout=compact&theme=tokyonight)
